...
await page.screenshot({ path: 'stardust/prototypes/v06-final-fold.png', fullPage: false });
...
await page.screenshot({ path: 'stardust/prototypes/v06-final-shot.png', fullPage: true });
await browser.close();
console.log('OK');
